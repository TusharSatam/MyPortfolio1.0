  ...
  return (
    <section className="pb-16 lg:py-24" id="projects">
      <div className="container">
        ...
        <p className="text-center md:text-lg lg:text-lg max-w-md mx-auto text-white/60 mt-4">
        ...
        <div className="flex flex-col mt-10 md:mt-20 gap-20">
          {PORTFOLIO_PROJECT.map((project, projectIndex) => (
            <Card
              key={project.title}
              className="pb-0 px-4 md:pt-12 pt-8 lg:px-20 lg:pt-16 sticky top-[30px]"
            >
              <div
                // href={project.slug}
              ...
              >
                <div className="lg:pb-16">
                  ...
                  <div className="flex flex-col gap-4 md:flex-row md:items-center mt-8">
                    <a
                      href={project?.isVideoAvailable?project.videoURL:project.link}
                      target="_blank"
                    ...
                    >
                      <button className="w-full inline-flex justify-center items-center gap-2 bg-white h-12 rounded-xl text-gray-950 md:w-auto px-6">
                        <span>{project?.isVideoAvailable?"View Project":`${project?.appType==="web"?"Visit live site":"Download"}`}</span>
                      {project?.isVideoAvailable?  <span>
                          <YoutubeIcon className="size-4 md:size-6" />
                        </span>:project?.appType==="web"?
                         <span>
